...
pub const RELOADABLE_FIELDS: &[&str] = &[
    ...
    "upstream.local_recovery.trigger_on_request_deadline",
    ...
    "upstream.stuck_watchdog.enabled",
    ...
    "upstream.restart_queue.enabled",
    ...
    "upstreams.local_recovery.trigger_on_request_deadline",
    ...
    "upstreams.stuck_watchdog.enabled",
    "upstreams.stuck_watchdog.detection_window_secs",
    "upstreams.stuck_watchdog.min_output_progress_units_in_window",
    "upstreams.stuck_watchdog.check_interval_secs",
    "upstreams.restart_queue.enabled",
    "upstreams.restart_queue.queue_deadline_secs",
    "upstreams.restart_queue.restart_timeout_secs",
